...
export const portfolio3dLightingProfiles = {
  studio: {
    ...
    fogFar: 14,
    ambientColor: '#dce8ff',
    ambientIntensity: tier(0.48, 0.38, 0.34),
    hemisphereSkyColor: '#dce8ff',
    hemisphereGroundColor: '#101923',
    hemisphereIntensity: tier(0.32, 0.28, 0.26),
    fallbackKeyColor: '#fff7e8',
    fallbackKeyPosition: [2.8, 3.8, 3.2],
    fallbackKeyIntensity: tier(0.92, 0.72, 0.58),
    importedIntensityMultiplier: 1,
    screenAccentMultiplier: 1,
    deskTaskMultiplier: 1,
    exposure: 0.98
  },
  focus: {
    background: '#04060a',
    ...
    fogFar: 12.5,
    ambientColor: '#c9dcff',
    ambientIntensity: tier(0.42, 0.32, 0.28),
    hemisphereSkyColor: '#cfe3ff',
    hemisphereGroundColor: '#0b121b',
    hemisphereIntensity: tier(0.28, 0.24, 0.22),
    fallbackKeyColor: '#fff1d5',
    fallbackKeyPosition: [2.2, 3.35, 2.65],
    fallbackKeyIntensity: tier(0.78, 0.58, 0.46),
  ...
  ambient: {
    ...
    fogFar: 15,
    ambientColor: '#d8e6ff',
    ambientIntensity: tier(0.56, 0.46, 0.42),
    hemisphereSkyColor: '#dce9ff',
    hemisphereGroundColor: '#152234',
    hemisphereIntensity: tier(0.38, 0.34, 0.3),
    fallbackKeyColor: '#fff8eb',
    fallbackKeyPosition: [2.8, 3.4, 3.1],
    fallbackKeyIntensity: tier(0.74, 0.52, 0.4),
    importedIntensityMultiplier: 0.58,
