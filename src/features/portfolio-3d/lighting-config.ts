...
export const portfolio3dLightingProfiles = {
  studio: {
    ...
    fogFar: 18,
    ambientColor: '#dce8ff',
    ambientIntensity: tier(0.82, 0.72, 0.66),
    hemisphereSkyColor: '#dce8ff',
    hemisphereGroundColor: '#101923',
    hemisphereIntensity: tier(0.5, 0.44, 0.4),
    fallbackKeyColor: '#fff7e8',
    fallbackKeyPosition: [2.4, 3.1, 3.6],
    fallbackKeyIntensity: tier(1.28, 1.12, 0.98),
  ...
  focus: {
    ...
    fogFar: 15.5,
    ambientColor: '#c9dcff',
    ambientIntensity: tier(0.66, 0.58, 0.52),
    ...
    fallbackKeyIntensity: tier(1.02, 0.86, 0.72),
