...
export const portfolio3dContentSnapshot = {
  ...
  publicExperienceCount: publicExperience.length,
...
export const portfolio3dSectionContracts = [
  {
    ...
    contentStrategy: 'Use existing landing and overview copy as DOM content; keep canvas as navigation context.'
  },
  {
    id: 'profile',
    label: 'Profile',
    ...
    dataSources: [
      ...
      dataSource('@/data/public-experience', 'publicExperience', 'short public career shape'),
      dataSource('@/data/education', 'education', 'education summary')
    ],
    primaryAssetId: 'room-shell',
    hotspotId: 'profile',
    contentStrategy: 'Keep profile concise and CV-first; avoid detailed employer/responsibility repetition.'
  },
  {
    id: 'experience',
    label: 'Experience',
    ...
    dataSources: [
      dataSource('@/data/public-experience', 'publicExperience', 'public career shape'),
      dataSource('@/data/profile', 'profile', 'role and availability')
    ],
    primaryAssetId: 'room-shell',
    contentStrategy: 'Show career arc only; exact companies, dates, and details stay in downloadable CV.'
  },
  {
    id: 'projects',
    label: 'Projects',
    ...
    dataSources: [dataSource('@/data/projects', 'projects', 'project cards and safe case-study data')],
    primaryAssetId: 'main-monitor',
    hotspotId: 'projects',
    screenNodeName: 'Screen_Projects',
    contentStrategy: 'Render project previews from existing project data; no private metrics or client facts.'
  },
  {
    id: 'fullstack',
    label: 'Full Stack',
    ...
    dataSources: [
      dataSource('@/data/capabilities', 'fullCycleNodes', 'frontend API backend data capability nodes'),
      dataSource('@/data/projects', 'projects', 'related full-stack project signals')
    ],
    primaryAssetId: 'laptop',
    hotspotId: 'fullstack',
    screenNodeName: 'Screen_Fullstack',
    contentStrategy: 'Use capability data to explain full-stack breadth without adding resume detail.'
  },
  {
    id: 'backend',
  ...
  },
  {
    ...
    dataSources: [
      dataSource('@/features/automation-lab/domain', 'simulation engine', 'deterministic automation scenarios'),
  ...
  },
  {
    ...
    dataSources: [dataSource('@/features/performance-lab/domain', 'threshold logic', 'performance scenarios')],
    primaryAssetId: 'hologram-projector',
    hotspotId: 'performance',
    screenNodeName: 'Hologram_Surface',
    contentStrategy: 'Use hologram surface for lightweight threshold preview and DOM for readable details.'
  },
  {
    id: 'pipeline',
    label: 'Pipeline',
  ...
  },
  {
    ...
    hotspotId: 'terminal',
    contentStrategy: 'Open the existing terminal rather than duplicating command parsing inside canvas.'
  },
  {
    id: 'contact',
    label: 'Contact',
    ...
    contentStrategy: 'Use existing contact data and CV link; phone/email/link targets stay data-driven.'
  }
